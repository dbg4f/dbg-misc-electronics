...
public class GenericSerialIo {
  ...
  GenericSerialIo(String portName, String dcbStr) throws IOException {
  ...
  public void write(byte[] bytes) throws IOException {
    ...
    log.debug("About to write " + bytes.length + " bytes");
    ...
    if (!res && err != W32Errors.ERROR_IO_PENDING) {
      ...
      log.info("WriteFile result = " + res + " err = " + err);
    }
    ...
    log.info("written = " + written.getValue());
